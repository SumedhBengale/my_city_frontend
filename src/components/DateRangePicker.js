  ...
  return (
    <div>{fetchComplete ?
      <div className='my-5 sm:mt-10 lg:mt-0 bg-white shadow-lg rounded-lg'>
        ...
        <div className='text-sms pl-5 text-primary'>{`${startDate === null ? '' : format(startDate, 'dd MMMM')
          ...
          <div className="grid grid-cols-7">
            {days.map((day) => (
              <div className="py-2 flex justify-center items-center">
                <div
                  key={day.date}
                  className={`flex w-full items-center justify-center cursor-pointer ${!isSameMonth(day.date, monthStart) ? 'text-gray-500 cursor-not-allowed' : ''
