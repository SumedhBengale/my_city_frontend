...
function SearchCard({search}) {
  ...
  return (
    ...
    {datePickerVisible && 
      <div className='fixed top-0 left-0 w-full flex flex-col justify-center items-center h-full z-30 backdrop-filter backdrop-blur-sm'
        //when clicked outside the date picker, close the date picker
        onClick={(e)=>{
          if(e.target.className === 'fixed top-0 left-0 w-full flex flex-col justify-center items-center h-full z-30 backdrop-filter backdrop-blur-sm'){
        ...
        <div className='grid grid-cols-2 gap-3 md:gap-9 text-white'>
          ...
          <div className='col-span-2 flex justify-between'>{/* Location and Filter */}
              <div className='flex cursor-pointer' onClick={()=>{
                ...
                {locationPickerVisible && <div className='absolute top-0 h-min w-40 translate-y-10 bg-white rounded-lg z-20 shadow-lg'
                >
          ...
          <div className='col-span-2 flex justify-between'>{/* Start and End Date Selector */}
            <div className='flex flex-col gap-5'>
              ...
              <div className='flex relative' onClick={()=>{
                ...
                { guestNumberPickerVisible && <div className='absolute top-0 h-min w-full translate-y-10 bg-white rounded-lg z-20 shadow-lg'>
                  <ul className='flex flex-col gap-1 text-black divide-y divide-black p-2 font-bold'>
            ...
            <div className='flex flex-col gap-5'>
              ...
              <div className='flex relative' onClick={()=>{
                ...
                { roomNumberPickerVisible && <div className='absolute top-0 h-min w-full translate-y-10 bg-white rounded-lg z-20 shadow-lg'>
                  <ul className='flex flex-col gap-1 text-black divide-y divide-black p-2 font-bold'>
      ...
      <div className="z-0 py-8 w-full max-w-7xl bg-white text-white bg-opacity-5 p-5 rounded-2xl border backdrop-blur-md hidden lg:block" >
          ...
          <div className='flex items-center' onClick={()=>{
            ...
            setLocationPickerVisible(!locationPickerVisible)}}>
                ...
                {locationPickerVisible && <div className='absolute top-0 h-min w-48 translate-y-24 bg-white rounded-lg z-20 shadow-lg'>
                  <ul className='flex flex-col gap-1 text-black divide-y divide-black p-2 font-bold'>
            ...
            <div className='flex items-center' onClick={()=>{
              ...
              <div className='pl-2'>
                ...
                { guestNumberPickerVisible && <div className='absolute top-0 h-min w-48 translate-y-24 bg-white rounded-lg z-20 shadow-lg'>
                  <ul className='flex flex-col gap-1 text-black divide-y divide-black p-2 font-bold'>
                    <li className='px-2 hover:bg-gray-200' onClick={()=>setSelectedGuests('any')}>Any</li>
                    <li className='px-2 hover:bg-gray-200' onClick={()=>setSelectedGuests(0)}>0</li>
                    <li className='px-2 hover:bg-gray-200' onClick={()=>setSelectedGuests(1)}>1</li>
            ...
            <div className='flex items-center' onClick={()=>{
              ...
              <div className='pl-2 relative'>
                ...
                { roomNumberPickerVisible && <div className='absolute top-0 h-min w-48 translate-y-24 bg-white rounded-lg shadow-lg'>
                  <ul className='flex flex-col gap-1 text-black divide-y divide-black p-2 font-bold'>
                    <li className='px-2 hover:bg-gray-200' onClick={()=>setSelectedBedrooms('any')}>Any</li>
                    <li className='px-2 hover:bg-gray-200' onClick={()=>setSelectedBedrooms(0)}>0</li>
                    <li className='px-2 hover:bg-gray-200' onClick={()=>setSelectedBedrooms(1)}>1</li>
