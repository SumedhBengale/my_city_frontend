...
function Filter({ apply, close }) {
  ...
  return (
    <>
      <div className='h-3/4 w-full z-30 fixed bottom-0  overflow-scroll bg-white rounded-t-2xl p-2 md:hidden'>
      ...
      <div className='h-max z-30 overflow-scroll bg-white rounded-2xl p-2 hidden md:block'>
        ...
        <div>
          <div className='font-custom text-lg m-5 font-bold'>Amenities</div>
