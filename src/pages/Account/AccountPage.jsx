        ...
        <div
          ...
          onClick={(e) => {
            if (
              ...
              !deleteDialogRef.current.contains(e.target)
            ) {
          ...
          <div className="uppercase z-40 h-full w-full sm:w-1/2 md:w-1/3">
            <div className="flex flex-col mx-5 mb-10 justify-center items-center h-full">
              ...
              >
                ...
                <div className="text-base font-custom-kiona text-primary px-2 pb-4">
                  Are you sure you want to delete your account? This action
                  cannot be undone.
                </div>
                <div className="flex w-full justify-center">
                  <button
                    className="bg-red-400 text-white font-custom-kiona text-base 2xl:text-xl px-5 py-2 rounded-lg uppercase hover:scale-105 transition duration-75"
              ...
              <div className="container mx-auto my-10">
                <div className="flex flex-col gap-5">
                  <div className="flex flex-col">
                    <label className="text-primary text-lg 2xl:text-2xl">
                      Email
                    </label>
                  ...
                  <div className="flex flex-row gap-5 w-full justify-between sm:justify-start">
                    <button
                      className="bg-primary text-white font-custom-kiona text-base 2xl:text-xl px-5 py-2 rounded-lg uppercase hover:scale-105 transition duration-75"
