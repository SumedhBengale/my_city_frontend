...
function FeaturedPropertyCard({ residence, highlighted }) {
  ...
  return (
    <div
      ...
      } bg-gray-200 hover:bg-gray-300 text-primary transition duration-75 rounded-2xl backdrop-blur-[185px] pb-5 mb-5`}
      onClick={() =>
    ...
    >
      ...
      <div className="flex mx-5">
        ...
        `}
            ...
            <div className={`pl-1 text-primary`}>{residence.beds}</div>
          </div>
          <div className="flex">
            <svg
              xmlns="http://www.w3.org/2000/svg"
        ...
        `}
            ...
            <div className={`pl-1 text-primary`}>{residence.bathrooms}</div>
          </div>
          <div className="flex">
            <svg
              xmlns="http://www.w3.org/2000/svg"
