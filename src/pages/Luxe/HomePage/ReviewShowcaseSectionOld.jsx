                ...
                >
                  ...
                  <div className="flex justify-center flex-col items-center">
                    ...
                    <div className="flex flex-col">
                      ...
                      <div className="text-slate-400 text-[12px] text-center">
                        {new Date(review.attributes.date).toLocaleDateString(
                          "en-GB"
                        )}
                      </div>
                      <div className="text-[14px] text-ellipsis overflow-hidden h-24 lg:h-36 text-center w-full text-primary overflow-y-auto">
...
function ReviewShowcaseSection() {
  return (
    <div className="w-full bg-zinc-100">
      <div className="font-custom-bold text-3xl text-center text-primary pt-10 container mx-auto">
        Hear From Our Happy Guests
      </div>
      <div className="text-zinc-900 text-opacity-40 text-center text-lg pt-3">
