          ...
          <div className='w-full h-full px-5'>
            <div className='flex flex-col justify-center items-center h-full bg-gray-200 w-full md:px-5 m-5 rounded-lg container mt-10 mx-auto'>
              ...
              <div className='flex flex-col md:max-w-2xl w-full justify-center md:items-start'>
                <input className=" md:w-full mx-3 h-12 px-2 mt-3 bg-white rounded-lg shadow-lg" type='email' placeholder='Email'>
                      {/* Email Input */}
                  </input>
                  <textarea 
                  //set number of lines
                  rows={5}
                  className="md:w-full mx-3 mt-3 h-36 md:h-36 p-2 bg-white rounded-lg shadow-lg" type='text' placeholder='Message'>
                      {/* Email Input */}
                  </textarea>
                  <div className='w-full flex justify-center'>
                  <div className=' rounded-lg px-3 w-full md:w-min hover:scale-105 transition duration-75 mt-3'>
                    <button className="bg-white border border-secondary hover:bg-primary hover:text-white text-primary c font-bold font-custom text-lg h-12 w-full md:w-40 rounded-lg my-2">Submit</button>
                  </div>
                  </div>
                </div>
