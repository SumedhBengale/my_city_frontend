...
function WishItem({ item }) {
  ...
  return (
    <>
      <div
        className="w-full h-full flex flex-col pb-6 p-2 rounded-xl cursor-pointer transition duration-75"
        onClick={() => {
      ...
      >
        <img
          src={
            item.residence.pictures[0].original
              ? item.residence.pictures[0].original
              : item.residence.pictures[0].thumbnail
          }
          alt="left arrow"
