                ...
                <div className='flex flex-col md:flex-row justify-between w-full'>
                    <div className='flex flex-col md:flex-row w-full md:w-1/3 justify-evenly order-2 md:order-1'>
                        <div className='pt-10 pl-5 py-10'>
                            ...
                            <div className="text-black text-md pt-3 pl-3 cursor-pointer" onClick={()=>navigate('/')}>Home</div>
                            <div className="text-black text-md pt-3 pl-3 cursor-pointer" onClick={()=>navigate('/properties')}>Properties</div>
                            <div className="text-black text-md pt-3 pl-3 cursor-pointer" onClick={()=>navigate('/homeowners')}>Rental Estimate</div>

                        </div>

                        <div className='pt-10 pl-5 py-10'>
                            <div className='font-custom-bold text-primary text-xl pl-3'>Company</div>
                            <div className="text-black text-md pt-3 pl-3 cursor-pointer" onClick={()=>navigate('/about')}>About Us</div>
                            <div className="text-black text-md pt-3 pl-3">Blogs</div>
                            <div className="text-black text-md pt-3 pl-3 cursor-pointer" onClick={()=>navigate('/homeowners')}>Management</div>
                        </div>
                    </div>
                    ...
                    <div className='flex flex-col h-min pt-4 px-4'>
                        <div className='flex justify-center mb-5'>        
                            <img src={black_logo} alt='logo' className='h-24 max-w-[300px] pt-5 md:pt-0'></img>
                        </div>
                        ...
                        <div className='flex justify-center mt-5 gap-5'>
                            ...
                            <div className='w-8 h-8 rounded-full border-[2px] border-black'>
                                <img src={facebook} alt='twitter' className='w-5 h-5 ml-1 mt-1 cursor-pointer'
                                    onClick={()=>{
                                        window.location.href = footer.find(
                            ...
                            <div className='w-8 h-8 rounded-full border-[2px] border-black'>
                                <img src={instagram} alt='twitter' className='w-5 h-5 ml-1 mt-1 cursor-pointer'
                                    onClick={()=>{
                                        window.location.href = footer.find(
                            ...
                            <div className='w-8 h-8 rounded-full border-[2px] border-black'>
                                <img src={linkedin} alt='twitter' className='w-5 h-5 ml-1 mt-1 cursor-pointer'
                                    onClick={()=>{
                                        window.location.href = footer.find(
