...
function KnowMoreSection() {
  return (
    ...
    <div className="w-full container mx-auto flex flex-col lg:flex-row justify-center items-center mt-10 lg:px-20">
        ...
        <div className="w-[178px] h-14  bg-transparent hover:bg-primary hover:text-white border border-secondary text-primary shadow-lg hover:scale-105 transition duration-75 cursor-pointer  rounded-xl backdrop-blur-md" >
          <div className=' text-2xl h-full flex justify-center items-center'>Know More</div>
        </div>
      </div>
      </div>
    </div>
