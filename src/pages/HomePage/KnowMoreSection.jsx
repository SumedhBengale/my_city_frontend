...
function KnowMoreSection() {
  return (
    ...
    <div className="w-full flex flex-col justify-center items-center mt-10">
        ...
        <div className='font-custom text-4xl font-bold text-center'>My City Residence</div>
        <div className='font-custom text-lg text-center'>Our Serviced Apartments</div>
