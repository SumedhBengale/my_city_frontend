  ...
  return (
    <div className='grid grid-cols-1 lg:grid-cols-2 justify-center items-center p-5 lg:p-20 lg:pl-10 gap-2'>
      <div className='text-center lg:text-left'>
        <div className='text-slate-400 text-sm pb-3'>Welcome to</div>
        <div className="text-black font-custom text-4xl font-bold capitalize pb-3">My City Residence</div>
        ...
        <img className="Image w-full h-[245px] lg:h-full rounded-lg p-5 lg:pr-10" src={homeBuilding} alt='Placeholder'/>
    </div>
  )
}
