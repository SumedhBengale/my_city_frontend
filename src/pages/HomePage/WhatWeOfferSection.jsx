      ...
      <div className="w-full bg-neutral-100 flex flex-col justify-center items-center mt-5 backdrop-blur-[185px] pb-10 px-5">
        ...
        <div className='flex flex-col lg:flex-row text-center items-center lg:items-start justify-around gap-10'>
          <div className='flex flex-col justify-center items-center mt-10 max-w-[400px]'>
            ...
            <div className='text-md text-primary text-center pt-3'>{dynamicText !== null && dynamicText.find((text) => text.attributes.name === 'WhatWeOffer_1_Subheading').attributes.text}</div>
          </div>
          ...
          <div className='flex flex-col justify-center items-center mt-10 max-w-[400px]'>
            ...
            <div className='text-md text-primary text-center pt-3'>{dynamicText !== null && dynamicText.find((text) => text.attributes.name === 'WhatWeOffer_2_Subheading').attributes.text}</div>
          </div>
          ...
          <div className='flex flex-col justify-center items-center mt-10 max-w-[400px]'>
            ...
            <div className='text-md text-primary text-center pt-3'>{dynamicText !== null && dynamicText.find((text) => text.attributes.name === 'WhatWeOffer_3_Subheading').attributes.text}</div>
          </div>
        </div>
        </div>
      </div>
