...
function AboutUsPage() {
  ...
  return (
    <div className="relative">
      ...
      <div
        className={`w-full flex flex-col fixed top-0 z-30 transition-all pt-24 sm:pt-20 2xl:pt-52 
      ${
        hidden
          ? setTimeout(() => {
              return "hidden";
