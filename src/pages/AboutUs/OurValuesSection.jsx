...
function OurValuesSection() {
  return (
    <>
        <div className='text-black text-center text-lg mt-10'>Our Values</div>
        ...
        <div className="flex flex-col items-center justify-center absolute top-5 left-0 w-full h-full z-10 scale-105">
            <div className="w-3/4  bg-opacity-5 rounded-2xl backdrop-blur-md p-4 mr-10 py-3 border">
                <div className='text-lg text-white font-bold text-center pb-2'>Performance</div>
      ...
      <div className="relative w-full pl-8 pt-10">
        ...
        <div className="flex flex-col items-center justify-center absolute top-5 left-0 w-full h-full z-10 scale-105">
            <div className="w-3/4  bg-opacity-5 rounded-2xl backdrop-blur-md p-4 ml-10 py-3 border">
                <div className='text-lg text-white font-bold text-center pb-2'>Service</div>
      ...
      <div className="relative w-full pr-8 pt-10">
        ...
        <div className="flex flex-col items-center justify-center absolute top-5 left-0 w-full h-full z-10 scale-105">
            <div className="w-3/4  bg-opacity-5 rounded-2xl backdrop-blur-md p-4 mr-10 py-3 border">
                <div className='text-lg text-white font-bold text-center pb-2'>Opportunities</div>
      ...
      <div className="relative w-full pl-8 pt-10">
        ...
        <div className="flex flex-col items-center justify-center absolute top-5 left-0 w-full h-full z-10 scale-105">
            <div className="w-3/4  bg-opacity-5 rounded-2xl backdrop-blur-md p-4 ml-10 py-3 border">
                <div className='text-lg text-white font-bold text-center pb-2'>Our Team</div>
