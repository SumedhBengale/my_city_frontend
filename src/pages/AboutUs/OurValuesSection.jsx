  ...
  return (
    <>
      ...
      <div className='w-full h-56 md:h-[400px] rounded-r-[50px] md:rounded-r-[150px]'>
          ...
          <div className='relative top-8 h-full flex items-center w-full justify-center'>
            <div className="absolute bottom-28 w-4/5 md:w-1/2 lg:w-2/3 md:py-10 h-max bg-white bg-opacity-5 rounded-2xl border border-white backdrop-blur-md container mx-auto">
              <div className=" w-full text-center text-white font-custom font-bold text-sm md:text-xl px-2 pb-1">Performance</div>
      ...
      <div className='w-full h-56 md:h-[400px] rounded-l-[50px] md:rounded-l-[150px]'>
          ...
          <div className='relative top-8 h-full w-full flex items-center justify-center'>
            <div className="absolute bottom-28 w-4/5 md:w-1/2 lg:w-2/3 md:py-10 h-max bg-white bg-opacity-5 rounded-2xl border border-white backdrop-blur-md container mx-auto">
              <div className=" w-full text-center text-white font-custom font-bold text-sm md:text-xl px-2 pb-1">Service</div>
      ...
      <div className='w-full h-56 md:h-[400px] rounded-r-[50px] md:rounded-r-[150px]'>
          ...
          <div className='relative top-8 h-full flex items-center w-full justify-center'>
            <div className="absolute bottom-28 w-4/5 md:w-1/2 lg:w-2/3 md:py-10 h-max bg-white bg-opacity-5 rounded-2xl border border-white backdrop-blur-md container mx-auto">
              <div className=" w-full text-center text-white font-custom font-bold text-sm md:text-xl px-2 pb-1">Opportunities</div>
      ...
      <div className='w-full h-56 md:h-[400px] rounded-l-[50px] md:rounded-l-[150px]'>
          ...
          <div className='relative top-8 h-full w-full flex items-center justify-center'>
            <div className="absolute bottom-24 w-4/5 md:w-1/2 lg:w-2/3 md:py-10 h-max bg-white bg-opacity-5 rounded-2xl border border-white backdrop-blur-md container mx-auto">
              <div className=" w-full text-center text-white font-custom font-bold text-sm md:text-xl px-2 pb-1">Our Team</div>
