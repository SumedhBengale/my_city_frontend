...
function OurValuesSection() {
  return (
    <>
        <div className='text-black text-center font-custom-bold text-lg mt-10'>Our Values</div>
      ...
      <div className='w-full h-64 md:h-[400px] rounded-r-[50px] md:rounded-r-[150px] relative'>
          ...
          <div className='absolute top-4 h-full w-full flex items-center justify-center pr-5'>
            ...
            <div className=" w-full text-center text-white font-custom-bold text-lg md:text-xl px-2 pb-1">Performance</div>
        ...
        <div className='w-full h-64 md:h-[400px] rounded-l-[50px] md:rounded-l-[150px] relative'>
          ...
          <div className='absolute top-4 h-full w-full flex items-center justify-center pl-5'>
            <div className=" w-4/5 md:w-1/2 lg:w-2/3 md:py-10 h-max flex flex-col justify-center gap-3">
              <div className=" w-full text-center text-white font-custom-bold text-lg md:text-xl px-2 pb-1">Service</div>
      ...
      <div className='w-full h-64 md:h-[400px] rounded-r-[50px] md:rounded-r-[150px] relative'>
          ...
          <div className='absolute top-4 h-full w-full flex items-center justify-center pr-5'>
            <div className=" w-4/5 md:w-1/2 lg:w-2/3 md:py-10 h-max flex flex-col gap-3">
            <div className=" w-full text-center text-white font-custom-bold text-lg md:text-xl px-2 pb-1">Opportunities</div>
        ...
        <div className='w-full h-64 md:h-[400px] rounded-l-[50px] md:rounded-l-[150px] relative'>
          ...
          <div className='absolute top-4 h-full w-full flex items-center justify-center pl-5'>
            <div className=" w-4/5 md:w-1/2 lg:w-2/3 md:py-10 h-max flex flex-col justify-center gap-3">
              <div className=" w-full text-center text-white font-custom-bold text-lg md:text-xl px-2 pb-1">Our Team</div>
