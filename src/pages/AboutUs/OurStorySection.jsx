    ...
    <div>
      {dynamicText !== null && dynamicImages !== null && (
        <div className="bg-white -translate-y-24 rounded-tl-[50px] md:rounded-tl-[100px]">
          <div className="grid grid-cols-1 lg:grid-cols-2 justify-center lg:px-20 lg:pt-20 lg:pl-10 gap-2 container mx-auto">
            <div className="flex justify-center w-full">
              <img
                className=" h-[400px] md:h-full w-full sm:w-1/2 lg:w-full rounded-tl-[80px] py-5 md:py-0 lg:pr-10"
                src={
                  `${config.STRAPI_URL}` +
                  dynamicImages.find(
            ...
            <div className="text-center lg:text-left pr-5 gap-5">
              <div className="text-secondary font-custom-kiona text-5xl capitalize pb-3 drop-shadow-lg">
                {dynamicText !== null &&
                  dynamicText.find(
