    ...
    <div className='absolute z-10 w-full'>
      ...
      {residence !== null ? <div className='absolute top-0 w-full z-0'>
        ...
        <div className='flex flex-row justify-between w-full p-5 items-center'>
          <div className='flex'>
            <div className='text-md self-center'>{residence.starRating}</div>
            <div className='flex justify-center items-center h-full self-center'>
              <img src={Star} alt="bed" className='w-4 h-4 mx-3 -translate-y-[2px]'/>
            </div>
            <div className='w-[1px] bg-black'></div>
            <div className=" text-black text-center text-md pl-2 line-clamp-1">{residence.address}</div>
          </div>
        ...
        <div className=" w-full px-5 text-black text-xs font-normal leading-normal">{residence.description}</div>
        ...
        <div className='w-full flex justify-between px-5'>
          <div className='flex flex-col'>
            <div className='text-md font-bold'>{`$ ${(residence.pricePerNight)*totalNights}`}</div>
          ...
          <div className=' flex justify-center'>
            <button className='text-white border border-black bg-black py-2 px-4 rounded-lg font-bold' onClick={()=>navigate('/book',{
              state: {
                residence: residence,
                startDate: startDate,
                endDate: endDate,
        ...
        <div className="mx-2 sm:container sm:mx-auto justify-center px-5 my-4">
          <PhotoGrid carouselOpen={()=>setCarouselVisible(true)} images={residence.images}/>
        </div>
        ...
        {residence ? <Amenities amenities={residence.amenities}></Amenities> : <div className='flex justify-center items-center mt-10'>
        ...
        { residence ? <MapContainer coordinate={residence.coordinate} /> :
        ...
        <div className='flex m-5'>
          <div className='w-full rounded-lg bg-gray-200'>
            ...
            {residence.rules['petsAllowed']=== false ? <div className='flex gap-2 pl-5 pb-3'>
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
            ...
            {residence.rules['partiesAllowed'] === false ? <div className='flex gap-2 pl-5 pb-3'>
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
            ...
            {residence.rules['childrenAllowed']=== false ? <div className='flex gap-2 pl-5 pb-3'>
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
      ...
      <div className='flex justify-between w-full p-5 items-center'>
        ...
        <div className='flex flex-row justify-between w-full p-5 items-center'>
          <div className='flex items-center'>
            ...
            <div className=" text-black text-md pl-2text-center line-clamp-1 ml-2">{residence.address}</div>
          </div>
        ...
        <div className='w-full flex justify-between px-5'>
          ...
          <div className=' flex justify-center'>
            <button className='text-white border border-black bg-black hover:scale-105 transition duration-75 py-2 px-4 rounded-lg font-bold' onClick={()=>navigate('/book',{
              state: {
                residence: residence,
                startDate: startDate,
                endDate: endDate,
