  ...
  return (
    ...
    <div className='absolute z-10 w-full'>
        <div className='flex justify-between m-3'>
          ...
          <div className="w-10 h-10 bg-zinc-300 flex justify-center items-center rounded-full">
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
      ...
      <div className='absolute top-0 w-full z-0'>
        ...
        <div className='flex flex-row justify-between w-full p-5 items-center'>
          <div className='flex'>
            <div className='text-md self-center'>5</div>
            ...
            <div className=" text-black text-md pl-2">Lyall St, London SW1X 8DW, UK</div>
          </div>
        ...
        <div className='flex m-5'>
          <div className='w-full rounded-lg bg-gray-200'>
            ...
            <div className='flex gap-2 pl-5 pb-3'>
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
              <path fill-rule="evenodd" clip-rule="evenodd" d="M8.9 13.151C9.56275 13.6379 9.69705 14.5589 9.2 15.2081L7.7 17.1673C7.4167 17.5373 6.97215 17.755 6.5 17.755H4.5C3.67158 17.755 3 17.0972 3 16.2857C3 15.4742 3.67158 14.8163 4.5 14.8163H5.75L6.8 13.4448C7.29705 12.7956 8.23725 12.6641 8.9 13.151Z" fill="#1C1C1C"/>
              ...
              <path d="M7.00003 13.9592C7.20003 12.5878 9.00003 11.2654 11.75 11.7551C12.5 13.7143 12.4014 17.6327 11.5 17.6327C9.00003 17.6327 8.58336 16.7347 8.25003 16.1633C7.75003 16 6.80003 15.3306 7.00003 13.9592Z" stroke="#1C1C1C" stroke-width="0.5" stroke-linecap="round"/>
              <path fill-rule="evenodd" clip-rule="evenodd" d="M16.75 9.9184C17.9927 9.9184 19 8.9316 19 7.71431C19 6.49702 17.9927 5.51023 16.75 5.51023C15.5073 5.51023 14.5 6.49702 14.5 7.71431C14.5 8.9316 15.5073 9.9184 16.75 9.9184ZM16.75 10.898C18.545 10.898 20 9.47263 20 7.71431C20 5.95599 18.545 4.53064 16.75 4.53064C14.955 4.53064 13.5 5.95599 13.5 7.71431C13.5 9.47263 14.955 10.898 16.75 10.898Z" fill="#1C1C1C"/>
            </svg>
              <div className=' text-sm'>Children Allowed</div>
            </div>
          </div>
        </div>

        {/* <div className='p-5 h-[500px] w-full'>
        <MapContainer coordinate={coordinate} />
