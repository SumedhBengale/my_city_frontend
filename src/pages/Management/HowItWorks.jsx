  ...
  return (
    <>
      ...
      > {/* Background Image */}
        ...
        <div className='text-4xl fond-bold text-white text-center pt-10'>How It Works?</div>
        ...
        <div className='w-full flex justify-center'>
            <div className=" w-full h-min m-5 bg-white bg-opacity-5 rounded-2xl border border-white backdrop-blur-xl">
                ...
                <div className=" w-full text-center text-white text-xl px-5 pt-5 capitalize leading-relaxed">1. With a corporate leasing arrangement, we become your tenant and give the following benefits.</div>
        ...
        <div className='w-full flex justify-center'>
            <div className=" w-full h-min m-5 bg-white bg-opacity-5 rounded-2xl border border-white backdrop-blur-xl">
                ...
                <div className=" w-full text-center text-white text-xl px-5 pt-5 capitalize leading-relaxed">2. We operate the property for you as a short-term rental.</div>
        ...
        <div className='w-full flex justify-center pb-5'>
            <div className=" w-full h-min m-5 bg-white bg-opacity-5 rounded-2xl border border-white backdrop-blur-xl">
                ...
                <div className=" w-full text-center text-white text-xl px-5 pt-5 capitalize leading-relaxed">3. We purchase the property</div>
