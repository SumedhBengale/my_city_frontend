  ...
  return (
    <>
      ...
      > {/* Background Image */}
        ...
        <div className='font-custom font-bold text-4xl fond-bold text-white text-center pt-10'>How It Works?</div>
        <div className='container mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 pb-20'>
          <div className='w-full h-full flex justify-center'>
              <div className=" w-full h-full m-5 bg-white bg-opacity-5 rounded-2xl border border-white backdrop-blur-xl">
                  ...
                  <div className=" w-full text-center text-white font-custom font-bold text-xl px-5 pt-5 capitalize leading-relaxed">1. With a corporate leasing arrangement, we become your tenant and give the following benefits.</div>
          ...
          <div className='w-full h-full flex justify-center'>
              <div className=" w-full h-full m-5 bg-white bg-opacity-5 rounded-2xl border border-white backdrop-blur-xl">
                  ...
                  <div className=" w-full text-center text-white font-custom font-bold text-xl px-5 pt-5 capitalize leading-relaxed">2. We operate the property for you as a short-term rental.</div>
          ...
          <div className='w-full h-full flex justify-center md:col-span-2 lg:col-span-1'>
              <div className=" w-full h-full m-5 bg-white bg-opacity-5 rounded-2xl border border-white backdrop-blur-xl">
                  ...
                  <div className=" w-full text-center text-white font-custom font-bold text-xl px-5 pt-5 capitalize leading-relaxed">3. We purchase the property</div>
