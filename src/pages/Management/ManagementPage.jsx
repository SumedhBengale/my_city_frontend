  ...
  return (
    <div className="relative">
          ...
          <div
            style={{
              ...
              backgroundImage: `url(${
                ...
                dynamicImages.find(
                  (image) =>
                    image.attributes.name === "HomeOwnersBackground.png"
                ).attributes.url
              })`,
      ...
      >
        {enquiryPopUpVisible && (
          <div
            className="fixed bottom-0 z-40 w-full h-full flex items-end justify-center md:items-center overflow-hidden backdrop-filter backdrop-blur-md"
      ...
      {loading === false ? (
        <div
          className="bg-white translate-y-0 rounded-tl-[50px] md:rounded-tl-[100px] z-30"
          style={{
            marginTop: "70vh",
          }}
        >
              ...
              <div className="text-center lg:text-left md:pr-5">
                ...
                <div className="text-primary font-custom-kiona uppercase text-2xl md:text-3xl pb-3">
                  {dynamicText !== null &&
                    dynamicText.find(
                      (text) =>
                        text.attributes.name === "Introduction_Subheading"
                    ).attributes.text}
                </div>
